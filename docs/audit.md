...
Cet audit va faire un état des lieux de l'application et servira de base pour concevoir la nouvelle architecture de l'application.

Il permettra de répondre aux questions suivantes :

1. l'application rempli sa fonction ?
1. l'application a des bogues ?
1. l'application est sécurisée ?
1. l'application est bien concue ?
1. l'application est scalable ( supporter une grosse volumétrie ) ?
1. l'application est résiliente ( continuité de service ) ?
...
- suit une architecture MVC
- définit un workflow clair
